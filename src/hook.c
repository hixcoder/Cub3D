...
{
	double moveStep = data->obj_plyr->walk_direction * data->obj_plyr->move_speed;
	double newPlayer_x = data->obj_plyr->x + cos(data->obj_plyr->rotation_angle+M_PI/2) * moveStep;
	double newPlayer_y = data->obj_plyr->y + sin(data->obj_plyr->rotation_angle+M_PI/2) * moveStep;
