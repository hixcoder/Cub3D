...
#    Updated: 2022/11/22 08:44:16 by lahammam         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# madatory
SRC_FOLDER = ./src/
SRC = main.c error.c map.c map_check.c ft_verifie_utils.c ft_verifie.c fill_data.c draw_utile.c player.c hook.c
