...
#    Updated: 2022/11/25 09:43:36 by lahammam         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# madatory
SRC_FOLDER = ./src/
SRC = main.c error.c map.c map_check.c ft_verifie_utils.c ft_verifie.c fill_data.c draw.c player.c hook.c ray_cast.c wall_rendring/wall_render.c
